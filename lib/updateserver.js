...
var UpdateServer = module.exports = function (sear, server, options) {
  this.sear = sear;
...
UpdateServer.prototype._fileUpdated = function (path, stats) {
...
UpdateServer.prototype.subscribe = function (filepath) {
