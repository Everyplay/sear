...
module.exports = function (files, options, callback) {
  ...
  function runTests() {
    ...
    if (options.cov_instrumentation || options.disable_console) {
      ...
      testSuiteFile += 'window.console = {log: function () {}, warn: function () {}, info: function () {}, debug: function () {}};\n';
    }
    ...
    options.cov_exclude = _.union([self.options.node_modules + '*', self.options.bower_components + '*', 'temptestsuite.js'], testFiles)
